...
letter=letter;
   ...
   // st7565_DrawChar2('A',1,2,1,0);

   // st7565_DrawString2('TEST',10,10,1,0);

   // st7565_DrawString('HABIP YIGITER',10,25,1,0);

    //st7565_DrawPixel(5,6,1);

    st7565_DrawString('Vg=', 0, SATIR6, 1, 0);
    st7565_DrawString('V', 48, SATIR6, 1, 0);
    st7565_DrawString('Fg=', 0, SATIR7, 1, 0);
    st7565_DrawString('Hz', 48, SATIR7, 1, 0);
    st7565_DrawString('U', 0, SATIR3, 2, 0);
   st7565_DrawChar(129, 12, SATIR3, 1, 0); //  Custom =
    //    KS0108_DrawString("27", 20, SATIR3, 2);
    st7565_DrawString('I', 64, SATIR3, 2, 0);
    st7565_DrawString('s', 73, SATIR4, 1, 0);
    st7565_DrawChar(0x81, 75, SATIR3, 1, 0); //  Custom =

    /*nokta koy*/
    st7565_DrawPixel(45, 28, 1);
    st7565_DrawPixel(46, 28, 1);
    st7565_DrawPixel(45, 29, 1);
    st7565_DrawPixel(46, 29, 1);

    /*nokta koy*/
    st7565_DrawPixel(114, 28, 1);
    st7565_DrawPixel(115, 28, 1);
    st7565_DrawPixel(114, 29, 1);
    st7565_DrawPixel(115, 29, 1);

    /*nokta koy*/
    st7565_DrawPixel(114, 52, 1);
    st7565_DrawPixel(115, 52, 1);
    st7565_DrawPixel(114, 53, 1);
    st7565_DrawPixel(115, 53, 1);

    st7565_DrawLine(0, 9, 126, 9, 1);

    st7565_DrawPixel(111, 52, 1);
    st7565_DrawPixel(112, 52, 1);
    st7565_DrawPixel(111, 53, 1);
    st7565_DrawPixel(112, 53, 1);

    st7565_DrawChar(SYMBOL_BUZZER1, 53, 1, 1, 0);
    st7565_DrawChar(SYMBOL_BUZZER2, 59, 1, 1, 0);

    st7565_DrawChar(SYMBOL_KILIT, 40, 1, 1, 0);
